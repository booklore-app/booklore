...
export class BookdropService {
  ...
  refetchMetadata(fileId: number, provider?: string): Observable<BookdropFile> {
    return this.http.post<BookdropFile>(`${this.url}/files/${fileId}/metadata/refetch`, provider ? {provider} : {});
  }
}
